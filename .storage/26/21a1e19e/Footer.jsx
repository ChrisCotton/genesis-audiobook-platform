    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h2 className="text-lg font-semibold mb-4">About Genesis</h2>
            <p className="text-gray-400 text-sm">
              Genesis is an AI-powered platform designed to revolutionize the way individuals 
              engage with written content, transforming any digital book into an interactive 
              audiobook and comprehensive learning ecosystem.
            </p>
          </div>
